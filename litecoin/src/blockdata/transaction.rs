...
///
/// ### Litecoin Core References
///
/// * [COutPoint definition](https://github.com/litecoin/litecoin/blob/345457b542b6a980ccfbc868af0970a6f91d1b82/src/primitives/transaction.h#L26)
...
impl OutPoint {
    ...
    ///
    /// ```rust
    /// use litecoin::constants::genesis_block;
    /// use litecoin::Network;
    ///
    /// let block = genesis_block(Network::Litecoin);
...
/// ### Litecoin Core References
///
/// * [CTxIn definition](https://github.com/litecoin/litecoin/blob/345457b542b6a980ccfbc868af0970a6f91d1b82/src/primitives/transaction.h#L65)
...
impl TxIn {
    ...
    ///
    /// [BIP-65](https://github.com/litecoin/bips/blob/master/bip-0065.mediawiki)
...
/// Litecoin transaction input sequence number.
///
...
///
/// [BIP-65]: <https://github.com/litecoin/bips/blob/master/bip-0065.mediawiki>
/// [BIP-68]: <https://github.com/litecoin/bips/blob/master/bip-0068.mediawiki>
/// [BIP-125]: <https://github.com/litecoin/bips/blob/master/bip-0125.mediawiki>
...
impl Sequence {
    ...
    /// is equivalent and improves readability for those not steeped in Litecoin folklore.
    ///
    /// ## Historical note
    ///
    /// The term 'final' is an archaic Litecoin term, it may have come about because the sequence
    /// number in the original Litecoin code was intended to be incremented in order to replace a
    /// transaction, so once the sequence number got to `u64::MAX` it could no longer be increased,
    /// hence it was 'final'.
    ///
    ///
    /// Some other references to the term:
    /// - `CTxIn::SEQUENCE_FINAL` in the Litecoin Core code.
    ...
    ///
    /// [BIP-112]: <https://github.com/litecoin/bips/blob/master/bip-0065.mediawiki>
    #[inline]
    ...
    /// to 512 seconds.
    ///
    /// Encoding finer granularity of time for relative lock-times is not supported in Litecoin
    #[inline]
...
/// ### Litecoin Core References
///
/// * [CTxOut definition](https://github.com/litecoin/litecoin/blob/345457b542b6a980ccfbc868af0970a6f91d1b82/src/primitives/transaction.h#L148)
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord, Debug, Hash)]
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(crate = "actual_serde"))]
pub struct TxOut {
...
///
/// See [Litecoin Wiki: Transaction][wiki-transaction] for more information.
///
/// [wiki-transaction]: https://en.litecoin.it/wiki/Transaction
///
/// ### Litecoin Core References
///
/// * [CTtransaction definition](https://github.com/litecoin/litecoin/blob/345457b542b6a980ccfbc868af0970a6f91d1b82/src/primitives/transaction.h#L279)
///
/// ### Serialization notes
///
...
pub struct Transaction {
    ...
    /// ### Relevant BIPs
    ///
    /// * [BIP-65 OP_CHECKLOCKTIMEVERIFY](https://github.com/litecoin/bips/blob/master/bip-0065.mediawiki)
    /// * [BIP-113 Median time-past as endpoint for lock-time calculations](https://github.com/litecoin/bips/blob/master/bip-0113.mediawiki)
...
impl Transaction {
    // https://github.com/litecoin/litecoin/blob/44b05bf3fef2468783dcebf651654fdd30717e7e/src/policy/policy.h#L27
    /// Maximum transaction weight for Litecoin Core 25.0.
    ...
    /// details see [BIP 141](https://github.com/litecoin/bips/blob/master/bip-0141.mediawiki)
    ...
    /// is different to what is implemented in Litecoin Core. The computation should be the same for
    /// any remotely sane transaction, and a standardness-rule-correct version is available in the
    /// [`policy`] module.
    ///
    /// > Virtual transaction size is defined as Transaction weight / 4 (rounded up to the next integer).
    ///
    /// [`BIP141`]: https://github.com/litecoin/bips/blob/master/bip-0141.mediawiki
    ...
    /// the RBF signal: <https://litecoinops.org/en/newsletters/2022/10/19/#transaction-replacement-option>.
    ...
    /// > ref: <https://litecoin.stackexchange.com/questions/117356/what-is-sigop-signature-operation#117359>
    ///
...
impl Version {
    /// The original Litecoin transaction version (pre-BIP-68).
    pub const ONE: Self = Self(1);

    /// The second Litecoin transaction version (post-BIP-68).
...
impl InputWeightPrediction {
    ...
    ///
    /// [signature grinding]: https://litecoin.stackexchange.com/questions/111660/what-is-signature-grinding
...
mod tests {
    ...
    fn is_coinbase() {
        ...
        let genesis = constants::genesis_block(Network::Litecoin);
    ...
    fn nonsegwit_transaction() {
        ...
        // In particular this one is easy to get backward -- in litecoin hashes are encoded
