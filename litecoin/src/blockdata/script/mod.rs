...
//!
//! <details>
//! <summary>What is Litecoin script</summary>
//!
//! Scripts define Litecoin's digital signature scheme: a signature is formed
...
//! the script leaves `TRUE` on the stack after being evaluated. Litecoin's
...
//!
//! See [Litecoin Wiki: Script][wiki-script] for more information.
//!
//! [Forth]: https://en.wikipedia.org/wiki/Forth_(programming_language)
//!
//! [wiki-script]: https://en.litecoin.it/wiki/Script
//! </details>
//!
...
//! and forcing them to be larger would waste memory and, in case of Litecoin script, even some
...
hashes::hash_newtype! {
    /// A hash of Litecoin Script bytecode.
    pub struct ScriptHash(hash160::Hash);
    /// SegWit version of a Litecoin Script bytecode hash.
...
/// more than 4 bytes, this is in line with Litecoin Core (see [`CScriptNum::serialize`]).
///
/// [`CScriptNum::serialize`]: <https://github.com/litecoin/litecoin/blob/8ae2808a4354e8dcc697f76bacc5e2f2befe9220/src/script/script.h#L345>
...
/// litecoind, that only 4-byte signed-magnitude values may be read as
...
///
/// This code is based on the `CScriptNum` constructor in Litecoin Core (see `script.h`).
pub fn read_scriptint(v: &[u8]) -> Result<i64, Error> {
    ...
    // Comment and code copied from Litecoin Core:
    // https://github.com/litecoin/litecoin/blob/447f50e4aed9a8b1d80e1891cda85801aeb80b4e/src/script/script.h#L247-L262
...
pub enum Error {
    ...
    /// <https://github.com/litecoin/bips/blob/master/bip-0062.mediawiki#push-operators>
    NonMinimalPush,
