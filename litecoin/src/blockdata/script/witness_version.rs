...
impl WitnessVersion {
    ...
    /// version in litecoin script. Thus, there is no function to directly convert witness version
    /// into a byte since the conversion requires context (litecoin script or just a version number).
