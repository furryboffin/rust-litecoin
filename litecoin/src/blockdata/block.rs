...
///
/// * [CBlockHeader definition](https://github.com/litecoin/litecoin/blob/345457b542b6a980ccfbc868af0970a6f91d1b82/src/primitives/block.h#L20)
...
/// Litecoin block version number.
///
/// Originally used as a protocol version, but repurposed for soft-fork signaling.
///
/// The inner value is a signed integer in Litecoin Core for historical reasons, if version bits is
...
/// ### Relevant BIPs
///
/// * [BIP9 - Version bits with timeout and delay](https://github.com/litecoin/bips/blob/master/bip-0009.mediawiki) (current usage)
/// * [BIP34 - Block v2, Height in Coinbase](https://github.com/litecoin/bips/blob/master/bip-0034.mediawiki)
...
impl Version {
    /// The original Litecoin Block v1.
    ...
    ///
    /// This is the data type used in consensus code in Litecoin Core.
...
///
/// See [Litecoin Wiki: Block][wiki-block] for more information.
///
/// [wiki-block]: https://en.litecoin.it/wiki/Block
///
/// ### Litecoin Core References
///
/// * [CBlock definition](https://github.com/litecoin/litecoin/blob/345457b542b6a980ccfbc868af0970a6f91d1b82/src/primitives/block.h#L62)
