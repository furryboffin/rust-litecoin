...
/// The Threshold for deciding whether a lock time value is a height or a time (see [Litecoin Core]).
///
...
///
/// Litecoin is able to safely use this value because a block height greater than 500,000,000 would
...
/// are, for obvious reasons, not useful within the Litecoin network.
///
/// [Litecoin Core]: https://github.com/litecoin/litecoin/blob/9ccaee1d5e2e4b79b0a7c29aadb41b97e4741332/src/script/script.h#L39
...
/// since epoch).
///
/// Used for transaction lock time (`nLockTime` in Litecoin Core and [`crate::Transaction::lock_time`]
...
/// # Examples
/// ```
/// # use litecoin::absolute::{LockTime, LockTime::*};
...
pub enum LockTime {
    ...
    /// # Examples
    /// ```rust
    /// use litecoin::absolute::LockTime;
    ///
...
impl LockTime {
    ...
    /// # Examples
    /// ```no_run
    /// # use litecoin::absolute::{LockTime, Height, Time};
...
impl Height {
    ...
    /// # Examples
    /// ```rust
    /// use litecoin::locktime::absolute::Height;
    ///
    /// let h: u32 = 741521;
...
impl Time {
    ...
    /// # Examples
    /// ```rust
    /// use litecoin::locktime::absolute::Time;
    ///
