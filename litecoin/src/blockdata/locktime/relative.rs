...
/// ### Relevant BIPs
///
/// * [BIP 68 Relative lock-time using consensus-enforced sequence numbers](https://github.com/litecoin/bips/blob/master/bip-0065.mediawiki)
/// * [BIP 112 CHECKSEQUENCEVERIFY](https://github.com/litecoin/bips/blob/master/bip-0112.mediawiki)
...
impl LockTime {
    ...
    ///
    /// ```rust
    /// # use litecoin::Sequence;
    /// # use litecoin::locktime::relative::{LockTime, Height, Time};
    ///
