...
// This module was largely copied from https://github.com/rust-litecoin/murmel/blob/master/src/blockfilter.rs
...
//! ### Relevant BIPS
//!
//! * [BIP 157 - Client Side Block Filtering](https://github.com/litecoin/bips/blob/master/bip-0157.mediawiki)
//! * [BIP 158 - Compact Block Filters for Light Clients](https://github.com/litecoin/bips/blob/master/bip-0158.mediawiki)
//!
//! # Examples
//!
//! ```ignore
...
impl BlockFilter {
    ...
    ///
    /// [BIP 157]: <https://github.com/litecoin/bips/blob/master/bip-0157.mediawiki#Filter_Headers>
    pub fn filter_header(&self, previous_filter_header: &FilterHeader) -> FilterHeader {
...
impl<'a, R: io::Read> BitStreamReader<'a, R> {
    ...
    /// # Examples
    /// ```
    /// # use litecoin::bip158::BitStreamReader;
    /// # let data = vec![0xff];
...
mod test {
    ...
    fn test_blockfilters() {
        // test vectors from: https://github.com/jimpo/litecoin/blob/c7efb652f3543b001b4dd22186a354605b14f47e/src/test/data/blockfilters.json
