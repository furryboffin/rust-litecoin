...
mod tests {
    ...
    fn test_base58_encode() {
        ...
        let res = encode(
            "LitecoinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoinBit\
        coinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoinLitecoin"
                .as_bytes(),
        );
        let exp =
