...
mod newtypes {
    ...
    hash_newtype! {
        /// A litecoin transaction hash/transaction ID.
        ///
        /// For compatibility with the existing Litecoin infrastructure and historical
        /// and current versions of the Litecoin Core software itself, this and
        ...
        /// A litecoin witness transaction ID.
        pub struct Wtxid(sha256d::Hash);
        /// A litecoin block hash.
