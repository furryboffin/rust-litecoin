...
pub const LITECOIN_SIGNED_MSG_PREFIX: &[u8] = b"\x18Litecoin Signed Message:\n";
...
mod message_signing {
    ...
    /// An error used for dealing with Litecoin Signed Messages.
    ...
    /// A signature on a Litecoin Signed Message.
    ///
...
/// Hash message for signature using Litecoin's message signing format.
pub fn signed_msg_hash(msg: &str) -> sha256d::Hash {
    let mut engine = sha256d::Hash::engine();
    engine.input(LITECOIN_SIGNED_MSG_PREFIX);
...
mod tests {
    ...
    fn test_signed_msg_hash() {
        ...
        assert_eq!(
            hash.to_string(),
            "2e7bb035af78841d69d9e76e60ba5f696311e4437ee2360ca30117687678d69c"
        );
    }
    ...
    fn test_message_signature() {
        ...
        let message = "rust-litecoin MessageSignature test";
        ...
        let p2pkh = Address::p2pkh(&pubkey, Network::Litecoin);
        assert_eq!(signature2.is_signed_by_address(&secp, &p2pkh, msg_hash), Ok(true));
        let p2wpkh = Address::p2wpkh(&pubkey, Network::Litecoin).unwrap();
        assert_eq!(
            signature2.is_signed_by_address(&secp, &p2wpkh, msg_hash),
            Err(MessageSignatureError::UnsupportedAddressType(AddressType::P2wpkh))
        );
        let p2shwpkh = Address::p2shwpkh(&pubkey, Network::Litecoin).unwrap();
        assert_eq!(
    ...
    fn test_incorrect_message_signature() {
        ...
        // Signature of msg = "rust-litecoin MessageSignature test"
