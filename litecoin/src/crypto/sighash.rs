...
//! [Bip341](https://github.com/litecoin/bips/blob/150ab6f5c3aca9da05fccc5b435e9667853407f4/bip-0341.mediawiki),
...
impl EcdsaSighashType {
    ...
    pub fn from_consensus(n: u32) -> EcdsaSighashType {
        ...
        // In Litecoin Core, the SignatureHash function will mask the (int32) value with
    ...
    pub fn from_standard(n: u32) -> Result<EcdsaSighashType, NonStandardSighashTypeError> {
        ...
        match n {
            // Standard sighashes, see https://github.com/litecoin/litecoin/blob/b805dbb0b9c90dadef0424e5b3bf86ac308e103e/src/script/interpreter.cpp#L189-L198
            0x01 => Ok(All),
            0x02 => Ok(None),
            0x03 => Ok(Single),
...
/// being relayed on today's Litecoin network.
#[derive(Debug, Clone, PartialEq, Eq)]
#[non_exhaustive]
...
impl<R: BorrowMut<Transaction>> SighashCache<R> {
    ...
    /// ```
    /// use litecoin::{absolute, transaction, Amount, Transaction, Script};
    /// use litecoin::sighash::{EcdsaSighashType, SighashCache};
    ///
...
impl<E> EncodeSigningDataResult<E> {
    ...
    ///
    /// ```rust
    /// # use litecoin::consensus::deserialize;
    /// # use litecoin::hashes::{Hash, hex::FromHex};
    /// # use litecoin::sighash::{LegacySighash, SighashCache};
    /// # use litecoin::Transaction;
    /// # let mut writer = LegacySighash::engine();
    /// # let input_index = 0;
    /// # let script_pubkey = litecoin::ScriptBuf::new();
...
mod tests {
    ...
    fn test_sighashes_keyspending() {
        // following test case has been taken from Litecoin Core test framework
