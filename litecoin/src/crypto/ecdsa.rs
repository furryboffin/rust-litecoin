...
//! ECDSA Litecoin signatures.
//!
//! This module provides ECDSA signatures used by Litecoin that can be roundtrip (de)serialized.
...
impl Signature {
    /// Constructs an ECDSA Litecoin signature for [`EcdsaSighashType::All`].
