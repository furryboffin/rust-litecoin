...
//! Partially Signed Litecoin Transactions.
//!
//! Implementation of BIP174 Partially Signed Litecoin Transaction Format as
//! defined at <https://github.com/litecoin/bips/blob/master/bip-0174.mediawiki>
...
/// The various output types supported by the Litecoin network.
...
/// Signing algorithms supported by the Litecoin network.
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
mod tests {
    ...
    use crate::network::Network::Litecoin;
    ...
    fn serialize_then_deserialize_output() {
        ...
        let mut sk: Xpriv = Xpriv::new_master(Litecoin, &seed).unwrap();
