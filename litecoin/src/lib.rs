...
//! # Rust Litecoin Library
//!
//! This is a library that supports the Litecoin network protocol and associated
//! primitives. It is designed for Rust programs built to work with the Litecoin
//! network.
//!
...
compile_error!(
    "rust-litecoin currently only supports architectures with pointers wider than 16 bits, let us
...
/// Litecoin's libbitcoinconsensus with Rust binding.
