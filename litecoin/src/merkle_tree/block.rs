...
//!
//! ```rust
//! use litecoin::hash_types::Txid;
//! use litecoin::hex::FromHex;
//! use litecoin::{Block, MerkleBlock};
//!
//! // Get the proof from a litecoind by running in the terminal:
//! // $ TXID="5a4ebf66822b0b2d56bd9dc64ece0bc38ee7844a23ff1d7320a88c5fdb2ad3e2"
//! // $ litecoin-cli gettxoutproof [\"$TXID\"]
...
//! let mb: MerkleBlock = litecoin::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl MerkleBlock {
    ...
    /// let block: Block = litecoin::consensus::deserialize(&block_bytes).unwrap();
    ///
...
impl PartialMerkleTree {
    ...
    /// use litecoin::hash_types::Txid;
    /// use litecoin::hex::FromHex;
    /// use litecoin::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
