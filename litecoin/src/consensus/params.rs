...
//! Litecoin consensus parameters.
//!
//! This module provides a predefined set of parameters for different Litecoin
...
pub struct Params {
    ...
    ///
    /// Note that this value differs from Litecoin Core's powLimit field in that this value is
    /// attainable, but Litecoin Core's is not. Specifically, because targets in Litecoin are always
    ...
    /// this is used in Litecoin Core's consensus algorithm is in comparison and there are no
    /// compact-expressible values between Litecoin Core's and the limit expressed here.
