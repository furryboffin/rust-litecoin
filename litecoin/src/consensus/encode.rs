...
//! Litecoin consensus-encodable types.
//!
...
/// Extensions of `Write` to encode data as per Litecoin consensus.
...
/// Extensions of `Read` to decode data as per Litecoin consensus.
