...
//! defined at <https://github.com/litecoin/bips/blob/master/bip-0174.mediawiki#test-vectors>

use core::convert::TryFrom;
use std::collections::BTreeMap;
use std::str::FromStr;

use litecoin::bip32::{Fingerprint, IntoDerivationPath, KeySource, Xpriv, Xpub};
use litecoin::blockdata::opcodes::OP_0;
use litecoin::blockdata::{script, transaction};
use litecoin::consensus::encode::{deserialize, serialize_hex};
use litecoin::hex::FromHex;
use litecoin::psbt::{Psbt, PsbtSighashType};
use litecoin::script::PushBytes;
use litecoin::secp256k1::{self, Secp256k1};
use litecoin::{
...
fn create_transaction() -> Transaction {
    ...
    Transaction {
        ...
        output: vec![
            TxOut {
                value: Amount::from_str_in(output_0.amount, Denomination::Litecoin)
                    .expect("failed to parse amount"),
                script_pubkey: ScriptBuf::from_hex(output_0.script_pubkey)
                    .expect("failed to parse script"),
            },
            TxOut {
                value: Amount::from_str_in(output_1.amount, Denomination::Litecoin)
                    .expect("failed to parse amount"),
...
#[track_caller]
fn signer_one_sign(psbt: Psbt, key_map: BTreeMap<litecoin::PublicKey, PrivateKey>) -> Psbt {
...
#[track_caller]
fn signer_two_sign(psbt: Psbt, key_map: BTreeMap<litecoin::PublicKey, PrivateKey>) -> Psbt {
...
fn sign(mut psbt: Psbt, keys: BTreeMap<litecoin::PublicKey, PrivateKey>) -> Psbt {
    let secp = Secp256k1::new();
