<div align="center">
  ...
  <img alt="Rust Litecoin logo by Hunter Trujillo, see license and source files under /logo" src="./logo/rust-litecoin.png" width="300" />
  ...
  <p>
    <a href="https://crates.io/crates/litecoin"><img alt="Crate Info" src="https://img.shields.io/crates/v/litecoin.svg"/></a>
    <a href="https://github.com/rust-litecoin/rust-litecoin/blob/master/LICENSE"><img alt="CC0 1.0 Universal Licensed" src="https://img.shields.io/badge/license-CC0--1.0-blue.svg"/></a>
    <a href="https://github.com/rust-litecoin/rust-litecoin/actions?query=workflow%3AContinuous%20integration"><img alt="CI Status" src="https://github.com/rust-litecoin/rust-litecoin/workflows/Continuous%20integration/badge.svg"></a>
    <a href="https://docs.rs/litecoin"><img alt="API Docs" src="https://img.shields.io/badge/docs.rs-litecoin-green"/></a>
    ...
    <a href="https://gnusha.org/litecoin-rust/"><img alt="Chat on IRC" src="https://img.shields.io/badge/irc-%23litecoin--rust%20on%20libera.chat-blue"></a>
    <a href="https://github.com/model-checking/kani"><imp alt="kani" src="https://github.com/rust-litecoin/rust-litecoin/actions/workflows/kani.yaml/badge.svg"></a>
  </p>
</div>

[Documentation](https://docs.rs/litecoin/)
...
For JSONRPC interaction with Litecoin Core, it is recommended to use
[rust-litecoincore-rpc](https://github.com/rust-litecoin/rust-litecoincore-rpc).
...
known and unknown, between this library and the Litecoin Core reference implementation. In a
consensus based cryptocurrency such as Litecoin it is critical that all parties are using the same
...
Currently can be found on [docs.rs/litecoin](https://docs.rs/litecoin/). Patches to add usage examples
...
[#litecoin-rust](https://web.libera.chat/?channel=#litecoin-rust) on
...
Generally this isn't a problem for `rust-litecoin` since we support much older versions than the
...
designed anyway](https://download.wpsoftware.net/litecoin/alts.pdf) we do not support any altcoins.
Supporting Litecoin properly is already difficult enough and we do not want to increase the
